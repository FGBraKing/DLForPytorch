...
class ResUnetPlusPlus(nn.Module):
    def __init__(self, channel, n_classes=1, filters=[32, 64, 128, 256, 512]):
        ...
        # self.output_layer = nn.Sequential(nn.Conv3d(filters[0], n_classes, 1), nn.Sigmoid())
        self.output_layer = nn.Sequential(nn.Conv3d(filters[0], n_classes, 1))
...
if __name__ == '__main__':
    ...
    net = ResUnetPlusPlus(channel=1, n_classes=1, filters=[32, 64, 128, 256, 512]).to(device)
