...
from models.modules.classification.three_d.ResNeXt3D import ResNeXt3D, ResNeXtBottleneck
...
if __name__ == '__main__':
    ...
    net = DAF3D().to(device)
    # input = torch.rand((1, 1, 80, 120, 160), requires_grad=True).to(device)
    #
    # print_model_parm_nums(net)  #
    # print_model_parm_flops(net, input, need_idx=False)   #

    from torchsummary import summary
    summary(net, input_size=(1,30,60,90), batch_size=1, device='cuda')
