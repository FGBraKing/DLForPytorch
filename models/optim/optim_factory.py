...
# def get_optimizer(model_or_params, optim_name='sgd', *args, **kwargs):
#     if optim_name.lower() == 'sgd':
#         # self, params, lr=required, momentum=0, dampening=0,
#         # weight_decay=0, nesterov=False
#         return torch.optim.SGD(model_or_params, lr=kwargs['lr'],
#                                momentum=kwargs['momentum'], dampening=kwargs['dampening'],
#                                weight_decay=kwargs['dampening'], nesterov=kwargs['nesterov'])
#     elif optim_name.lower() == 'adam':
#         # self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
#         # weight_decay=0, amsgrad=False
#         return torch.optim.Adam(model_or_params, lr=kwargs['lr'],
#                                 betas=kwargs['betas'], eps=1e-8,
#                                 weight_decay=0, amsgrad=False)
#     else:
#         print('This optimizer is not yet supported')
#         raise ValueError
#
#
# # optimizer: __init__  __setstate__  step
