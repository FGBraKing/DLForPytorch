...
python  train.py  \
                  ...
                  --draw_model  --DDP   --continue_train --SyncBatchNorm

# --local_rank 0
# --max_dataset_size  --DP --DDP  --up_interpolate --ignore_index  --lr_noise --continue_train -save_by_iter
# --with_html --with_visdom --play_video  --display_histogram  --SyncBatchNorm



# trus_unet3d_testDDP_muti_node
# --nnodes 2 --node_rank 1 --nproc_per_node 3 --master_addr 172.21.16.17  --master_port 15000 \
